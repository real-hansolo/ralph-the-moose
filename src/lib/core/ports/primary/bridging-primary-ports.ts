import type {
  TBridgingRequest,
  TBridgingProgressResponse,
  TBridgingSuccessResponse,
  TBridgingErrorResponse,
  TBridgingEstimateGasResponse,
} from "../../usecase-models/bridging-usecase-models";
...
export interface BridgingOutputPort<TResponse> {
  ...
  presentEstimatedGas(response: TBridgingEstimateGasResponse): void;
}
